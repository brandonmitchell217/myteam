...
export default function Clients({ clients }: any) {
  ...
  return (
    <section className="relative bg-sherpa text-white py-32 md:py-40">
      <LeftImage>
        <BgLeft height={200} width={200} />
      </LeftImage>
      <div className="max-w-6xl m-auto relative z-10 px-4 sm:px-8 md:px-4 lg:px-0 space-y-20 md:space-y-12">
